...
:setvar DefaultDataPath "C:\Microsoft SQL Server\MSSQL\Data\"
:setvar DefaultLogPath "C:\Microsoft SQL Server\MSSQL\Data\Logs\"
...
GO
PRINT N'Creating FK_FactRepo_DimCalendar_CloseDateKey...';


GO
ALTER TABLE [DW].[FactRepo] WITH NOCHECK
    ADD CONSTRAINT [FK_FactRepo_DimCalendar_CloseDateKey] FOREIGN KEY ([CloseDateKey]) REFERENCES [DW].[DimCalendar] ([CalendarKey]) ON DELETE NO ACTION ON UPDATE NO ACTION;


GO
PRINT N'Creating FK_FactRepo_DimCalendar_HoldDateKey...';


GO
ALTER TABLE [DW].[FactRepo] WITH NOCHECK
    ADD CONSTRAINT [FK_FactRepo_DimCalendar_HoldDateKey] FOREIGN KEY ([HoldDateKey]) REFERENCES [DW].[DimCalendar] ([CalendarKey]) ON DELETE NO ACTION ON UPDATE NO ACTION;


GO
PRINT N'Creating FK_FactRepo_DimCalendar_OrderDateKey...';


GO
ALTER TABLE [DW].[FactRepo] WITH NOCHECK
    ADD CONSTRAINT [FK_FactRepo_DimCalendar_OrderDateKey] FOREIGN KEY ([OrderDateKey]) REFERENCES [DW].[DimCalendar] ([CalendarKey]) ON DELETE NO ACTION ON UPDATE NO ACTION;


GO
PRINT N'Creating FK_FactRepo_DimCalendar_RepoDateKey...';


GO
ALTER TABLE [DW].[FactRepo] WITH NOCHECK
    ADD CONSTRAINT [FK_FactRepo_DimCalendar_RepoDateKey] FOREIGN KEY ([RepoDateKey]) REFERENCES [DW].[DimCalendar] ([CalendarKey]) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
END
GO
PRINT N'Creating [DW].[usp_InsertDefaultCalendarRecord]...';
